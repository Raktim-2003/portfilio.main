...
export default function Hero() {
  const words = [
    ...
    "JavaScript Developer & Creator of LifeLogix & Jarvies",
    "Learning MARN Stack",
...
const profile = {
    ...
    skills: [
        'React', 'HTML', 'PYTHON', 'Express','CSS',
        'MySQL', 'MongoDB', 'JAVASCRIPT', 'AWS', 'TypeScript',
        'FIGMA','BOOTSTRAP', 'Git', 'Linux', 'JAVA'
    ],
    hardWorker: true,
    quickLearner: true,
    problemSolver: true,
            ...
            <div className="w-full lg:w-1/2 mb-12 lg:mb-0 animate__animated animate__fadeInLeft relative">
              ...
              <div className="relative mb-8 sm:mb-12 max-w-xl">
                <p className="text-base sm:text-xl text-gray-300/90 leading-relaxed">
                  Web Developer 💻 | Creator of LifeLogix & Jarvies 🔧 | MERN
                  Stack Explorer 🚀
                </p>
              </div>
              ...
              <div className="flex flex-col sm:flex-row gap-4 sm:gap-6 animate__animated animate__fadeInUp animate__delay-2s">
                ...
                <a
                  href="https://github.com/Raktim-2003"
                ...
                {/* Contact Button */}
                <a
                  href="/Resume/Raktim_Mondal_resume.pdf"
                  download="Raktim_Mondal_resume.pdf"
